...
public class AdapterSubSita extends RecyclerView.Adapter<AdapterSubSita.ItemViewHolder> implements Filterable {
    private List<Item> itemList;
    private List<Item> itemListFull;
    private Activity activity;

     //AdapterSubSita
    public AdapterSubSita(Activity activity, List<Item> itemList) {
    ...
    @NonNull
    @Override
    public AdapterSubSita.ItemViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterSubSita.ItemViewHolder itemViewHolder, int i) {
