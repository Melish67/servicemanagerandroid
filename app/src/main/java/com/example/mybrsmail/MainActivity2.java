...
public class MainActivity2 extends AppCompatActivity {
    ...
    private void functionReloadBaggageList() {
        LinearLayoutManager layoutManager = new LinearLayoutManager(MainActivity2.this);
        AdapterSubList itemAdapter = new AdapterSubList(MainActivity2.this, buildItemList());
        ...
        call.enqueue(new Callback<List<ServiceDto>>() {
            ...
            public void onResponse(Call<List<ServiceDto>> call, Response<List<ServiceDto>> response) {
                if (response.isSuccessful()) {
                    ...
                    itemAdapter = new AdapterSubList(MainActivity2.this, itemList);
                    rvItem.setAdapter(itemAdapter);
                    rvItem.invalidate();
                } else {
